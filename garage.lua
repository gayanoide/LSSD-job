...
RegisterNetEvent('lssd:garagemenu')
AddEventHandler('lssd:garagemenu', function(type, data)
    if ESX.PlayerData.job and ESX.PlayerData.job.name == 'lssd' then        
        exports.ox_lib:showContext('spawnlssd')
    else
