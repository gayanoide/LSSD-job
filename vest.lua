...
RegisterCommand('Emyhelmetlssd', function()
...
RegisterNetEvent('lssd:vestmenu')
AddEventHandler('lssd:vestmenu', function(type, data)
    if ESX.PlayerData.job and ESX.PlayerData.job.name == 'lssd' then        
        exports.ox_lib:showContext('vestlssd')
    else
